...
public class WhatsNew extends WhatsNewUi{
	...
	public void whatsNewClick()throws ReusableComponentException, Exception
	{
		WebDriverSupport.click(driver, whatsnewButton, " Home page", "whatsNew button", log, test);
		Thread.sleep(2000);
	}
	public void clickItem(String item) throws ReusableComponentException, Exception
	{
		
		if(driver.findElement(header).isDisplayed() &&driver.findElement(header).getText().toLowerCase().contains("What's New".toLowerCase()))
		{
