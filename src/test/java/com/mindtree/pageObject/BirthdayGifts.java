...
import com.mindtree.uiStore.BirthdayGiftsUi;
...
public class BirthdayGifts extends BirthdayGiftsUi{
	...
	ExtentTest test;
	private String type;
	public BirthdayGifts(WebDriver driver, Logger log, ExtentTest test) throws Exception {
		this.driver = driver;
		this.test = test;
		this.log = log;
	}
	...
	{
		new Actions(driver).moveToElement(driver.findElement(BirthdayGiftsButton)).build().perform();
	}
